...
public class manufacturerDropdownVisibleTest extends BaseTestClass {
	...
	public void manufacturerVisbleTest() {
		logger = report.createTest("Manufacture DropDown is Present");
		...
		upcomingBikesPage.verifyVisibilityManufacturer();
	}
